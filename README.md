...
- Automatically traces internal dependencies across 41 python files.
...
graph TD
    ...
    node_1["custom_types.py"]
    click node_1 href "../custom_types.py"
    node_2["main.py"]
    click node_2 href "../code/main.py"
    node_3["conftest.py"]
    click node_3 href "../code/conftest.py"
    node_4["__main__.py"]
    click node_4 href "../code/__main__.py"
    node_5["cross_ecosystem.py"]
    click node_5 href "../code/cross_ecosystem.py"
    node_6["answer_synthesis.py"]
    click node_6 href "../code/answer_synthesis.py"
    node_7["postprocess.py"]
    click node_7 href "../code/postprocess.py"
    node_8["response_quality_report.py"]
    click node_8 href "../code/response_quality_report.py"
    node_9["run_eval.py"]
    click node_9 href "../code/run_eval.py"
    ...
    node_13["csv_io.py"]
    click node_13 href "../code/csv_io.py"
    node_14["grounding.py"]
    click node_14 href "../code/grounding.py"
    node_15["taxonomy.py"]
    click node_15 href "../code/taxonomy.py"
    node_16["compare_outputs.py"]
    click node_16 href "../code/compare_outputs.py"
    ...
    node_21["corpus.py"]
    click node_21 href "../code/corpus.py"
    node_22["test_risk.py"]
    click node_22 href "../code/tests/test_risk.py"
    node_23["test_eval_metrics.py"]
    click node_23 href "../code/tests/test_eval_metrics.py"
    node_24["test_sample_routing_golden.py"]
    click node_24 href "../code/tests/test_sample_routing_golden.py"
    node_25["test_merge_cli.py"]
    click node_25 href "../code/tests/test_merge_cli.py"
    node_26["test_taxonomy.py"]
    click node_26 href "../code/tests/test_taxonomy.py"
    node_27["test_ticket_hints.py"]
    click node_27 href "../code/tests/test_ticket_hints.py"
    node_28["test_module_invocation.py"]
    click node_28 href "../code/tests/test_module_invocation.py"
    node_29["test_csv_io.py"]
    click node_29 href "../code/tests/test_csv_io.py"
    ...
    node_34["health_dashboard.py"]
    click node_34 href "../automation/health_dashboard.py"
    node_35["readme_generator.py"]
    click node_35 href "../automation/readme_generator.py"
    node_36["analyzer.py"]
    click node_36 href "../automation/analyzer.py"
    node_37["ai_maintainer.py"]
    click node_37 href "../automation/ai_maintainer.py"
    node_38["ai_agent.py"]
    click node_38 href "../automation/ai_agent.py"
    node_39["diagrams.py"]
    click node_39 href "../automation/diagrams.py"
    node_40["__init__.py"]
    click node_40 href "../automation/__init__.py"
    node_2 --> node_12
    node_2 --> node_12
    node_2 --> node_12
    node_2 --> node_12
