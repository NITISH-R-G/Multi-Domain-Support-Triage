...
**Module:** `response_quality_report.py`
...
**Module:** `tests/test_sample_routing_golden.py`
...
**Module:** `tests/test_merge_cli.py`

CLI exits when gold vs pred produce zero merge rows.


**Module:** `tests/test_module_invocation.py`

CLI ``--help`` works when launched from ``code/`` (same as CI).


**Module:** `tests/test_cross_ecosystem.py`
