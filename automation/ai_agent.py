...
def generate_docs(repo_graph, root_dir):
    if OpenAI is None or not os.environ.get("OPENAI_API_KEY"):
        ...
        return {"summary": "AI generation skipped.", "onboarding_guide": "AI generation skipped."}

    client = OpenAI()

    # Load some key files to give context to the LLM
    problem_statement = load_file_content(os.path.join(root_dir, 'problem_statement.md'))
    ...
    try:
        ...
        return {"architecture_summary": "Auto-generated summary failed.", "onboarding_guide": "Auto-generated onboarding failed."}
