...
def get_bandit_issues(code_dir):
...
def get_safety_issues(code_dir):
...
def generate_health_dashboard():
    ...
    bandit_issues, bandit_high = get_bandit_issues(code_dir)
    safety_issues = get_safety_issues(code_dir)
