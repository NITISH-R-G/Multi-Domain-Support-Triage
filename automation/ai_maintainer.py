...
def extract_pr_info(event_data, action):
...
def extract_issue_info(event_data, action):
    if (
        "issue" in event_data
...
def extract_comment_info(event_data, action):
...
def extract_event_info(event_data, action):
    result = extract_pr_info(event_data, action)
    if result:
        return result
    result = extract_issue_info(event_data, action)
    if result:
        return result
    result = extract_comment_info(event_data, action)
    if result:
        return result
    return None, "", "", ""
