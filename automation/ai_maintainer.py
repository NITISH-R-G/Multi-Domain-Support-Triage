...
def process_pull_request_event(event_data):
    return (
...
def process_issue_event(event_data):
    return (
...
def process_comment_event(event_data):
...
def parse_event(event_data, action):
    if "pull_request" in event_data and action in ["opened", "edited"]:
        return process_pull_request_event(event_data)
    elif (
        "issue" in event_data
        and action in ["opened", "edited"]
        and "pull_request" not in event_data["issue"]
    ):
        return process_issue_event(event_data)
    elif "comment" in event_data and action == "created":
        return process_comment_event(event_data)
    return None, None, None, None
